...
const ViewStatusTask = ({
    ...
    return(
        <>
            <div class={'w-[100%] flex bg-[#F7F8F9] rounded-[10px] shadow-2xl relative z-10 '}>
                <div className={'flex w-full items-center my-[15px] ml-[40px]'}>
                    <img src={iconoExam.src} className='text-[#0082C9]' ></img>
                    <div className='flex flex-col' >
                        <label className={'font-open text-[21px] font-bold text-[#535353] ml-[10px]'}>Tareas</label>
            ...
            <div class={'w-[100%] flex bg-input-white rounded-[10px] mt-[-30px] '}>
                <div className='flex flex-col font-open text-[11px] font-semibold text-[#818181]  my-[15px] ml-[40px]' >
                    <label className={`cursor-pointer changeItem ${selectedFilter === 'Todas' ? 'text-[#0082C9]' : 'text-[#818181]'}`} onClick={() => handleFilterClick('Todas')}>Todas</label>
                    ...
                    <label className={`cursor-pointer changeItem ${selectedFilter === 'Calificadas' ? 'text-[#0082C9]' : 'text-[#818181]'}`} onClick={() => handleFilterClick('Calificadas')}>Calificadas</label>
