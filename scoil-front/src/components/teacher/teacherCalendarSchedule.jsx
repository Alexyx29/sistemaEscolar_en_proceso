...
const ParentsCalendarSchedule = ({ horarioAlumn, }) =>{
                ...
                <div className="flex w-full">
                    ...
                    {horarioAlumn && (
                        <div className="w-[100%] flex text-center" >
                            <span className=" w-full font-open text-[35px] font-bold text-gray-date-txt  ">{title}</span>
                        </div>
                    )}                                                     
...
export default ParentsCalendarSchedule;