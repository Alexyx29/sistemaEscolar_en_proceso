...
import logoScoil from "../assets/logo/logo-scoil.svg"
            ...
            <Modal id="scoil" 
                ...
                <div>
                    ...
                    <div className="ml-[px] mt-[px] w-full " >
                        ...
                        <button className="absolute z-10 w-[31px] h-[31px] ml-[25px] mt-[25px] flex items-start" onClick={close}>
                            <img src={circleArrow.src} alt="" action={close} className="z-10 w-[31px] h-[31px] " />
                        </button>

                        <span className="flez flex-col " >
                            <div className="flex">
                                <div className=" w-[39px] h-[79px] z-10 ml-[70px] mt-[82px] ">
                                    <img src={logoScoil.src} alt="" />
                                </div>
                                <div className="flex flex-col text-left w-[380px] z-10 font-open font-sans ml-[18px] mt-[72px]  ">
                            ...
                            <div className=" ml-[60px] mt-[13px] font-open text-[12px] text-[#606060] text-left ">
                                ...
                                <span className="w-[158px] ml-[562px] mr-[15px]">
                                {textModal.email}
                                </span>
