...
import logoInnova from "../assets/logo/logoInnova.svg"
...
import '../styles/triangleInnova.css'; 





const PaymentReceiptInnova = ({submit}) => {

    const textModal = {
        school:"UNIVERSIDAD INNOVA",
    ...
    const TrianguloInnova = () => {
        return (
            <div className='ml-[5px] mt-[px] w-full' >
                <div className="triangulo-containerInnova  mt-[px]">
                    <div className="trianguloInnova  "></div>
                </div>
            </div>
        );
    };
                ...
                <div>
                    ...
                    <div className="ml-[px] mt-[px] w-full " >
                        ...
                        <span className="flez flex-col " >
                            <div className="flex">
                                <div className="w-[85px] h-[85px] z-10 ml-[55px] mt-[70px] ">
                                    <img src={logoInnova.src} alt="" className="w-[85px] h-[85px]  " />
                                </div>
                                <div className="flex flex-col text-left w-[380px] z-10 font-open font-sans ml-[10px] mt-[70px]  ">
    ...
    export default PaymentReceiptInnova;
