...
import imec from "../assets/logo/imec.svg"
...
const PaymentReceiptImec = ({submit}) => {
    ...
    const TrianguloImec = () => {
        return (
            <div className='ml-[px] mt-[px] w-full' >
                <div className="triangulo-containerImec  mt-[px]">
                    <div className="trianguloImec  "></div>
                </div>
            </div>
        );
    };
                ...
                <div>
                    ...
                    <div className="ml-[px] mt-[px] w-full " >
                        ...
                        <span className="flez flex-col " >
                            <div className="flex">
                                <div className="w-[83px] h-[83px] z-10 ml-[60px] mt-[78px] ">
                                    <img src={imec.src} alt="" />
                                </div>
    ...
    export default PaymentReceiptImec;
